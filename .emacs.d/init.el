...
(custom-set-variables
 ...
 '(package-selected-packages
	 '(elpy diff-hl material-theme magit helm markdown-mode ag flycheck indent-guide nord-theme all-the-icons powerline smartparens smartparens-config rainbow-mode company use-package))
